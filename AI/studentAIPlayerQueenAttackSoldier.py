...
class AIPlayer(Player):
    ...
    def __init__(self, inputPlayerId):
        super(AIPlayer,self).__init__(inputPlayerId, "Simple Drone->Queen Attack And Food Gatherer Soldier")
        self.myFood = None
        self.myTunnel = None
